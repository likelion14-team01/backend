INSERT IGNORE INTO users (user_id, name, email, created_at, updated_at)
VALUES (1, '데모 사용자', 'demo@leaflog.com', NOW(), NOW());

INSERT IGNORE INTO species (species_id, name, watering_interval_days, category, description, interval_text, image_url, created_at, updated_at)
VALUES
